...
- Chọn một trong đúng ba kiểu xếp lịch trình: Cân bằng, Hoàn tất xét nghiệm sớm hoặc Ra viện sớm.
...
- **Cân bằng:** cân đối thời gian hoàn tất xét nghiệm, thời gian gặp lại bác sĩ, quãng đường di chuyển và độ ổn định của lộ trình.
- **Hoàn tất xét nghiệm sớm:** ưu tiên làm xong toàn bộ xét nghiệm và chẩn đoán hình ảnh sớm nhất; thời gian chờ để gặp lại bác sĩ có thể lâu hơn.
- **Ra viện sớm:** ưu tiên hoàn tất dịch vụ, gặp lại bác sĩ và kết thúc toàn bộ lượt khám sớm nhất.

Trong tài liệu này, **xét nghiệm và chẩn đoán hình ảnh** bao gồm lấy mẫu, xét nghiệm máu, siêu âm, X-quang và các dịch vụ tạo hình ảnh tương tự được bác sĩ chỉ định.

“Ra viện sớm” chỉ là cách tối ưu thời gian toàn hành trình. Bệnh nhân chỉ được rời bệnh viện khi bác sĩ hoặc quy trình bệnh viện xác nhận lượt khám đã hoàn tất; ứng dụng không tự quyết định cho bệnh nhân ra viện.
...
|---|---|---|---|
| Mức 1 — Chọn kiểu xếp lịch trình | Chọn “Cân bằng”, “Hoàn tất xét nghiệm sớm” hoặc “Ra viện sớm” | Tạo tối đa ba phương án trọn tuyến theo đúng mốc thời gian cần tối ưu | Phù hợp với phần lớn bệnh nhân |
...
- Nhu cầu xe lăn, thang máy, cách ly hoặc hạn chế di chuyển là điều kiện bắt buộc phải đáp ứng, không phải một kiểu xếp lịch trình thứ tư.
...
→ Bệnh nhân chọn một trong ba kiểu xếp lịch trình
...
Ví dụ so sánh ba kiểu xếp lịch trình với cùng một bộ chỉ định. Các mốc dưới đây là dữ liệu minh họa:

| Kiểu xếp lịch trình | Lộ trình minh họa | Xong toàn bộ xét nghiệm | Gặp lại bác sĩ | Kết thúc lượt khám | Đánh đổi chính |
|---|---|---:|---:|---:|---|
| Cân bằng | Lấy máu tầng 1 → X-quang tầng 2 → Siêu âm tầng 2 | 11:05–11:20 | 11:30–11:50 | 11:40–12:00 | Cân đối thời gian, di chuyển và độ ổn định |
| Hoàn tất xét nghiệm sớm | Lấy máu khu B → X-quang khu B → Siêu âm khu B | 10:50–11:05 | 11:50–12:20 | 12:00–12:30 | Xong xét nghiệm sớm nhưng có thể chờ bác sĩ lâu hơn |
| Ra viện sớm | Lấy máu tầng 1 → X-quang tầng 2 → Siêu âm tầng 2 | 11:00–11:15 | 11:20–11:35 | 11:30–11:45 | Xét nghiệm có thể xong muộn hơn một chút nhưng toàn lượt khám kết thúc sớm nhất |
...
#### 4.3.2. Mốc thời gian cần tối ưu

| Kiểu xếp lịch trình | Mốc được ưu tiên nhất | Các yếu tố vẫn phải kiểm tra |
|---|---|---|
| Cân bằng | Tổng hợp cả thời gian xong xét nghiệm và thời gian kết thúc lượt khám | Quãng đường, số lần đổi tầng, độ đông và nguy cơ lộ trình thay đổi |
| Hoàn tất xét nghiệm sớm | Thời điểm dịch vụ cuối cùng hoàn tất | Điều kiện chuẩn bị, thứ tự chuyên môn và khả năng nhận của từng phòng |
| Ra viện sớm | Thời điểm bệnh nhân gặp lại bác sĩ và được xác nhận kết thúc lượt khám | Thời gian trả kết quả, khả năng bác sĩ tiếp nhận lại và tất cả dịch vụ bắt buộc |

Hai mốc “xong toàn bộ xét nghiệm” và “kết thúc lượt khám” phải luôn được hiển thị riêng. Không dùng một nhãn chung như “hoàn tất sớm” vì dễ khiến bệnh nhân hiểu nhầm.

#### 4.3.3. Cách hệ thống xếp thứ tự
...
7. Với kiểu Hoàn tất xét nghiệm sớm, thời gian chờ gặp lại bác sĩ là thông tin bắt buộc nhưng không phải mốc tối ưu chính.
8. Với kiểu Ra viện sớm, phải kiểm tra khả năng bác sĩ tiếp nhận lại; không được chỉ làm xong dịch vụ sớm rồi để bệnh nhân chờ lâu.
...
#### 4.3.4. Tình huống minh họa đầy đủ

Các mốc dưới đây minh họa kiểu **Ra viện sớm** và là **dữ liệu cho bản trình diễn**, không phải cam kết thời gian thực tế:
...
**Hành động chính:** “Chọn kiểu xếp lịch trình”.

**Hành động phụ:** “Nhờ nhân viên hỗ trợ”.

### 6.2. Màn hình Chọn kiểu xếp lịch trình

**Mục đích:** để bệnh nhân chọn rõ mốc muốn hệ thống tối ưu mà không phải hiểu cách vận hành của bệnh viện.

**Các lựa chọn:**

| Lựa chọn | Mô tả hiển thị |
|---|---|
| Cân bằng | “Cân đối thời gian làm xét nghiệm, thời gian gặp bác sĩ, quãng đường và độ ổn định” |
| Hoàn tất xét nghiệm sớm | “Làm xong toàn bộ xét nghiệm và chẩn đoán hình ảnh sớm nhất; bạn có thể chờ bác sĩ lâu hơn” |
| Ra viện sớm | “Tối ưu để làm xong dịch vụ, gặp lại bác sĩ và kết thúc lượt khám sớm nhất” |

Mỗi lựa chọn là một thẻ có tên, mô tả ngắn, mốc thời gian được tối ưu và dấu chọn rõ ràng. Không dùng màu làm dấu hiệu duy nhất.

Ban đầu không chọn sẵn kiểu nào. Bệnh nhân phải chủ động chọn một thẻ; khung bên dưới minh họa trạng thái sau khi đã chọn “Hoàn tất xét nghiệm sớm”.

**Hành động chính:** “Tạo phương án”.

**Hành động phụ:** “Cập nhật nhu cầu hỗ trợ di chuyển”. Nhu cầu này được áp dụng cho cả ba kiểu, không tạo thêm kiểu xếp lịch trình.

Khung giao diện gợi ý:

```text
┌──────────────────────────────────┐
│ Bước 2/4 — Chọn kiểu lịch trình  │
│ Bạn muốn tối ưu mốc nào?         │
├──────────────────────────────────┤
│ ○ Cân bằng                       │
│   Cân đối toàn bộ hành trình     │
│                                  │
│ ● Hoàn tất xét nghiệm sớm        │
│   Xong xét nghiệm sớm nhất       │
│   Có thể chờ bác sĩ lâu hơn      │
│                                  │
│ ○ Ra viện sớm                    │
│   Kết thúc toàn lượt khám sớm    │
├──────────────────────────────────┤
│ [Tạo phương án]                  │
...
**Mục đích:** so sánh tối đa ba phương án hợp lệ được xếp theo kiểu bệnh nhân vừa chọn.

**Mỗi thẻ phương án hiển thị:**

- Nhãn Phương án tốt nhất, Phương án thay thế 1 hoặc Phương án thay thế 2.
- Kiểu xếp lịch trình đang áp dụng.
- Khoảng thời gian xong toàn bộ xét nghiệm.
- Khoảng thời gian gặp lại bác sĩ.
- Khoảng thời gian kết thúc lượt khám.
...
│ Kiểu: Hoàn tất xét nghiệm sớm    │
├──────────────────────────────────┤
│ PHƯƠNG ÁN TỐT NHẤT               │
│ Xong xét nghiệm: 10:50–11:05     │
│ Gặp lại bác sĩ: 11:50–12:20      │
│ Kết thúc lượt khám: 12:00–12:30  │
│ Lấy máu → X-quang → Siêu âm      │
│ 260 m · đổi tầng 1 lần           │
│ Vì sao: xong các dịch vụ sớm nhất│
│ [Chọn lộ trình này]              │
│ Xem chi tiết và đổi phòng        │
├──────────────────────────────────┤
│ PHƯƠNG ÁN THAY THẾ 1             │
│ Xong xét nghiệm: 11:00–11:15     │
│ Gặp lại bác sĩ: 11:35–11:55      │
│ Kết thúc lượt khám: 11:45–12:05  │
│ [Chọn lộ trình này]              │
└──────────────────────────────────┘
```
...
|---|---:|---:|
| Xong toàn bộ xét nghiệm | 10:50–11:05 | 11:00–11:15 |
| Gặp lại bác sĩ | 11:50–12:20 | 11:35–11:55 |
| Kết thúc lượt khám | 12:00–12:30 | 11:45–12:05 |
...
- Phòng đã chọn.
- Tóm tắt hành trình.
- Kiểu xếp lịch trình bệnh nhân đã chọn.
- Khoảng thời gian xong toàn bộ xét nghiệm.
- Khoảng thời gian gặp lại bác sĩ và kết thúc lượt khám.
...
|---|---|---|---|
| Chọn kiểu xếp lịch trình | Đánh dấu một trong ba kiểu và bật nút “Tạo phương án” | Xếp các phương án theo đúng mốc thời gian cần tối ưu | Không thay đổi chỉ định hoặc mức ưu tiên y tế |
...
- Nhu cầu hỗ trợ di chuyển.
- Kiểu xếp lịch trình bệnh nhân chọn cho hành trình hiện tại.
- Vị trí hiện tại hoặc điểm bắt đầu đã được xác nhận.

### 11.2. Đầu ra

- Lộ trình được chọn.
- Kiểu xếp lịch trình và các phòng bệnh nhân đã chủ động thay đổi.
- Chỗ được giữ.
...
- Bệnh nhân chỉ nhìn thấy đúng ba kiểu xếp lịch trình: Cân bằng, Hoàn tất xét nghiệm sớm và Ra viện sớm.
- Khi chọn Hoàn tất xét nghiệm sớm, giao diện cảnh báo rõ thời gian chờ bác sĩ có thể lâu hơn.
- Khi chọn Ra viện sớm, hệ thống tính cả khả năng gặp lại bác sĩ và chỉ cho rời viện khi được xác nhận.
- Mọi phương án đều hiển thị riêng thời gian xong xét nghiệm và thời gian kết thúc lượt khám.
